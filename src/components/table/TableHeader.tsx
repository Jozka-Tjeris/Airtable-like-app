                  ...
                  >
                    {!header.isPlaceholder && (
                      ...
                      >
                        ...
                        <div
                          className={`w-[80%]} flex flex-grow cursor-pointer flex-row items-center gap-1.5 overflow-hidden transition-colors hover:text-gray-900`}
                        >
                          ...
                          <span
                            ...
                            onDoubleClick={() => {
                              ...
                              if (newLabel && newLabel.trim() !== "")
                                handleRenameColumn(columnId, newLabel.trim());
                            }}
                          >
                            {flexRender(
